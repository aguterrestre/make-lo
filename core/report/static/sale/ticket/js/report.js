...
$(function () {
    ...
    // Filtro por fecha de registro del comprobate
    $('input[name="date_joined_range"]').daterangepicker({
    ...
    // Filtro por cliente del comprobate
    $('select[name="client"]').select2({
        ...
        client_filter = e.params.data.id;
        generate_report();
